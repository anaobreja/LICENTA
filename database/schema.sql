...
DROP TABLE IF EXISTS train_cars CASCADE;
...
-- ============================================================
-- SECTIUNE: VAGOANE, LOCURI SI LIFECYCLE BILET (Migrare 06)
-- ============================================================
-- Adaugata pentru: anti-overlap, seat selection real-time,
-- cancel cu refund (trepte CFR), reschedule pe acelasi traseu.
-- Backfill-ul genereaza ~500k locuri pentru toate trenurile.
-- ============================================================
...
CREATE INDEX idx_seat_reservations_expires
    ON seat_reservations(expires_at);
CREATE INDEX idx_seat_reservations_train_date
...
CREATE INDEX idx_ticket_seats_seat   ON ticket_seats(seat_id);
...
CREATE INDEX idx_tickets_rescheduled_from
